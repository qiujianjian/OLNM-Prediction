...
# DOI: numerical input
DOI = st.number_input("DOI (mm):", min_value=0.1, max_value=10.2, value=7.5)
...
# NLR: numerical input
NLR = st.number_input("Neutrophil-to-Lymphocyte Ratio:", min_value=0.00, max_value=6.00, value=2.80)
